            ...
            <div class="flex flex-col lg:flex-row items-center gap-6">
                ...
                <div class="lg:w-1/2 space-y-4">
                    ...
                    <p class="text-gray-600 text-lg max-w-md">
                        Let's find your dream destinations. Here, we recommend beautiful places and affordable trips for you and your beloved family.
                    </p>
                 
                </div>
                <!-- Bagian Gambar -->
                <div class="lg:w-1/3">
                    <img src="{{ asset('img/image33.png') }}" alt="Deskripsi Gambar" class="w-full h-auto rounded-2xl shadow-md">
                </div>
            </div>
                            ...
                            <div class="group">
                                <div class="relative">
                                    <select name="package" required
                                        ...
                                        <option value="before_neubasic">Before Wedding - Neubasic (Rp 2.750.000)</option>
                                        <option value="before_neusweat">Before Wedding - Neusweat (Rp 4.000.000)</option>
                                        <option value="traditional_neubasic">Traditional Sessions - Neubasic (Rp 3.300.000)</option>
                                        <option value="traditional_neusweat">Traditional Sessions - Neusweat (Rp 3.800.000)</option>
                                        <option value="prewedding_neubasic">Pre Wedding - Neubasic (Rp 3.000.000)</option>
                                        <option value="prewedding_neusweat">Pre Wedding - Neusweat (Rp 4.000.000)</option>
                                        <option value="wedding_intimate">Wedding Intimate (Rp 3.300.000)</option>
                                        <option value="wedding_neusweat">Wedding Day - Neusweat (Rp 4.000.000)</option>
                                        <option value="wedding_neudeluxe">Wedding Day - Neudeluxe (Rp 6.000.000)</option>
                                        <option value="photo_only">Photo Only (Rp 2.250.000)</option>
                                        <option value="video_only">Video Only (Rp 2.250.000)</option>
                                    </select>
                                </div>
                            </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="package-card bg-white rounded-lg shadow-lg overflow-hidden relative">
                    <!-- Package Image Full -->
                    <div class="package-image h-full overflow-hidden relative">
                        <img src="/img/prewed_session.jpg" 
                             alt="Basic Package" 
                             class="w-full h-full object-cover">
                    </div>
                </div>
